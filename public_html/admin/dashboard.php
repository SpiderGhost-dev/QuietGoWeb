...
<head>
    ...
    <title>QuietGo Hub - Admin Dashboard</title>
    ...
    <style>
        /* Override base styles for admin dark theme */
        body {
        ...
        /* Universal Header - matches main site but with admin nav */
        .site-header {
            position: sticky;
            top: 0;
            z-index: 50;
        ...
        .admin-layout {
            display: flex;
            min-height: calc(100vh - 137px); /* Account for header + footer */
        }
        ...
        .nav-item:hover {
            background: rgba(189, 205, 222, 0.1);
            color: var(--accent-color);
            border-left-color: var(--accent-color);
        }

        .nav-item.active {
            background: rgba(189, 205, 222, 0.15);
            color: var(--accent-color);
            border-left-color: var(--accent-color);
            font-weight: 600;
        }
        ...
        .status-pro {
            background-color: rgba(140, 157, 138, 0.2);
            color: var(--green-color);
        }
