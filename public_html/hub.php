                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 32px;">
                    <div>
                        ...
                        <div style="display: flex; gap: 16px; align-items: center;">
                            ...
                            <span id="healthStreak" style="color: var(--green-color); font-size: 0.875rem; font-weight: 500;">🔥 3 day tracking streak</span>
                        </div>
                    </div>
                ...
                <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px; margin-bottom: 48px;">
                    ...
                    <div class="card card-premium" data-testid="card-overview">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                            <h2 style="color: var(--accent-color);">📊 Your Health Overview</h2>
                    ...
                    <!-- Subscription Status -->\n                    <div class="card card-featured" data-testid="card-subscription">
                        <div style="text-align: center; margin-bottom: 20px;">
                            <div style="width: 48px; height: 48px; background: linear-gradient(135deg, var(--accent-dark), var(--accent-color)); border-radius: 50%; margin: 0 auto 16px; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem;">✨</div>
